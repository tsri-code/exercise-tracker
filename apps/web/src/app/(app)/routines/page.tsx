            ...
            <div key={r.id} className="card p-4">
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {r.items?.map((it: any) => (
                  <div
                    key={it.id}
                    className="rounded-md bg-white/5 ring-1 ring-white/10 p-3"
                  >
              ...
              <div className="mt-3 text-right">
                <a
                  href={`/routines/${r.id}`}
                  className="text-xs text-black bg-cyan-400 hover:bg-cyan-300 px-3 py-1 rounded-full font-semibold"
                >
                  Edit
                </a>
              </div>
